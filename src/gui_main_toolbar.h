...
void GuiMainToolbar(GuiMainToolbarState *state)
{
    ...
    GuiComboBox((Rectangle){ state->anchorVisuals.x + 8 + 48, state->anchorVisuals.y + 8, 120, 24 }, 
        "Light;Jungle;Candy;Lavanda;Cyber;Terminal;Ashes;Bluish;Dark;Cherry;Sunny;Enefete;Amber;RLTech;Genesis;Wisteria;Pocket;Brick;Advance;Turbo", &state->visualStyleActive);
