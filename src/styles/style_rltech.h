...
#define RTECH_STYLE_PROPS_COUNT  17

// Custom style name: rltech
static const GuiStyleProp rltechStyleProps[RTECH_STYLE_PROPS_COUNT] = {
    ...
    { 0, 19, (int)0xf5f5f5ff },    // DEFAULT_BACKGROUND_COLOR 
...
static unsigned char rltechFontData[RTECH_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static void GuiLoadStyleRLtech(void)
{
    ...
    unsigned char *data = DecompressData(rltechFontData, RTECH_STYLE_FONT_ATLAS_COMP_SIZE, &rltechFontDataSize);
